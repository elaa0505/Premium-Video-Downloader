...
?>
<head>
      <title class="pTitle">GMV App -  Online Download Video, Audio, GIF Photo from YouTube & More</title>
      ...
      <script src="<?php echo $serverdomain; ?>/js/dvtool.js" defer></script>
      <link rel="stylesheet" type="text/css"  href="<?php echo $domainSSL; ?>/css/w3.css">
      <link rel="stylesheet" type="text/css"  href="<?php echo $domainSSL; ?>/css/style.css">
      <link rel="stylesheet" type="text/css"  href="<?php echo $domainSSL; ?>/css/bootstrap_002.css">
      <link href="<?php echo $domainSSL; ?>/css/bootstrap.css" rel="stylesheet" type="text/css"  id="bootstrap-css">
